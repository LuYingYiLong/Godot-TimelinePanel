...
namespace godot {
	...
	class TimelinePanelBase : public Control {
		GDCLASS(TimelinePanelBase, Control)
	...
	public:
		...
		enum PanelOrientation {
			PANEL_ORIENTATION_VERTICAL,
			PANEL_ORIENTATION_HORIZONTAL,
		};
	...
	private:
		...
		PanelOrientation panel_orientation = PANEL_ORIENTATION_VERTICAL;
		double duration = 0.0;
		...
		float _get_time_ruler_width() const;
		float _get_horizontal_track_header_width() const;
		float _get_horizontal_track_height() const;
		float _get_horizontal_ruler_height() const;
		float _calculate_track_span() const;
	...
	protected:
		...
		void _set_panel_orientation(PanelOrientation p_orientation);
		PanelOrientation _get_panel_orientation() const;
...
VARIANT_ENUM_CAST(TimelinePanelBase::CountingUnit);
VARIANT_ENUM_CAST(TimelinePanelBase::TimeFormat);
VARIANT_ENUM_CAST(TimelinePanelBase::BeatFormat);
VARIANT_ENUM_CAST(TimelinePanelBase::BarNumberDirection);
